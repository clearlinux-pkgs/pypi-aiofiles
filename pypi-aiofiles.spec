...
Source0  : https://files.pythonhosted.org/packages/40/a0/07be94aecba162ed5147359f9883e82afd2ac13aed33678a008fc8c36f8b/aiofiles-23.1.0.tar.gz
...
%prep
%setup -q -n aiofiles-23.1.0
cd %{_builddir}/aiofiles-23.1.0
pushd ..
cp -a aiofiles-23.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675969059
